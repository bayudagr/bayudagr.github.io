						...
						<div class="row">
								   ...
								   <!-- Tab panes -->
									...
									<div class="tab-content">
									 ...
									 <div role="tabpanel" class="tab-pane" id="flights">
										<div class="row">
										<h1 align="center">Login Ke Raja Mural</h1>
							...
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									 ...
									 <center>
								  <span class="price style1">Raja Mural Indonesia
						                    </center>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						...
						<p>Silahkan daftar untuk memesan jasa kami</p>
					</div>
				</div>
				<form action="proses.php?aksi=tambah" method="post" enctype="multipart/form-data">
					<div class="row animate-box">
						<div class="col-md-6">
							<h3 class="section-title">@RajaMuralIndonesia</h3>
							<p>Jasa Pembuatan Mural Untuk Memperindah Ruangan Anda</p>
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>Raja Mural</li>
								<li><i class="icon-phone2"></i>085691568857</li>
								<li><i class="icon-mail"></i><a href="#">rajamural@gmail.com</a></li>
								<li><i class="icon-globe2"></i><a href="#">rajamural.com</a></li>
							</ul>
						</div>
						<div class="col-md-6">
							<div class="row">
