			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Order List</h3>
						<h2>Pembayaran Melalui Rek BRI Atas Nama Raja Mural</h2>
						<h2>No Rek : 12345678910</h2>
				...
				<table class="table table-bordered table-striped table-hover">
                	<thead>
                    	<tr class="info fg-white">
                            ...
                            <th class="text-left">Paket Mural </th>
                            <th class="text-left">Paket Cat</th>
                            <th class="text-left">Transport</th>
                            <th class="text-left">Harga Paket</th>
                            <th class="text-left">Harga Cat</th>
